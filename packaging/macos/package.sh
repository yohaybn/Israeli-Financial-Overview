...
echo ""
echo "[2/7] Sharp for this OS (icon generation; npm/cli#4828 / foreign lockfile) ..."
# Do NOT run `npm install rollup` here — it prunes @img/sharp-darwin-* and breaks icons:generate.
...
# Rollup after Sharp: `npm install sharp` drops @rollup/rollup-*; Vite needs it restored.
