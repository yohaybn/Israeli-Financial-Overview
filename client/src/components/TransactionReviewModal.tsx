...
export function TransactionReviewModal({
    ...
    return (
        <Modal labelledBy="transactionreviewmodal-title" onClose={onClose} zIndex={50} overlayClassName="p-4 sm:p-6 bg-gray-900/60 backdrop-blur-sm" panelClassName="bg-white rounded-2xl shadow-2xl w-full max-w-6xl max-h-[90vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                <div className="flex items-start justify-between gap-4 p-5 sm:p-6 border-b border-gray-100 bg-sky-50/40">
                    <div className="flex gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                            <h2 id="transactionreviewmodal-title" className="text-lg font-bold text-gray-900">{t('transaction_review.modal_title')}</h2>
